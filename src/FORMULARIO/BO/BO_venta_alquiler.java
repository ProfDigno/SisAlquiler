...
public class BO_venta_alquiler {
    ...
    public boolean getBoolean_insertar_venta_alquiler1(venta_alquiler vealq, credito_cliente ccli, cliente clie, JTable tbltabla) {
    ...
    public boolean getBoolean_update_venta_alquiler_anular(venta_alquiler vealq, credito_cliente ccli, cliente clie) {
