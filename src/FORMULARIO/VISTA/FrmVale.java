...
//        }
    ...
    void cargar_datos_caja() {
        ...
        caja.setC9monto_vale(evejtf.getDouble_format_nro_entero(txtmonto_vale));
        caja.setC10monto_caja(0);
        caja.setC11monto_cierre(0);
        caja.setC12id_origen(idvale);
        caja.setC13tabla_origen("VALE");
        //        caja.setC14cierre("C");
    ...
    void cargar_datos_vale() {
        ...
        val.setMonto_vale(evejtf.getDouble_format_nro_entero(txtmonto_vale));
