...
//    private int fk_iddato_banco_cliente=0;
    ...
    private void abrir_formulario() {
        ...
        color_formulario();
        if(ENTrpc.getQuien_llama()==3){
            panel_nuevo_recibo.setBackground(Color.yellow);
            monto_recibo_pago=ENTrpc.getMonto_sena_venta();
...
//    }
    private void color_formulario() {
        ...
        panel_nuevo_recibo.setBackground(clacolor.getColor_insertar_primario());
    }
...
//                String monto_recibo = evejtf.getString_format_nro_entero(monto_recibo_pago);
    ...
    private void cargar_recibo_pago_cliente() {
        ...
        String fecha_recibo = evefec.getString_validar_fecha(txtfecha_recibo.getText());
        ENTrpc.setC14fecha_recibo(fecha_recibo);
    }
...
//        String Smonto_saldo_credito = String.valueOf(monto_saldo_credito);
        String Smonto_saldo_credito = evejtf.getString_format_nro_entero(monto_saldo_credito);
        String Smonto_letra = nroletra.Convertir(Smonto_saldo_credito, true);
        ENTscc.setC5monto_letra(Smonto_letra);
    ...
    private void cargar_dato_transccion_banco() {
        if (tipo_pago == 3) {
            String fecha_transaccion = evefec.getString_validar_fecha(txtfecha_transaccion.getText());
            ...
            ENTtb.setC8fk_idrecibo_pago_cliente2(fk_idrecibo_pago_cliente);
            ENTtb.setC9fecha_transaccion(fecha_transaccion);
        }
    }
        ...
        if (hab_guardar) {
            if (validar_guardar()) {
                ...
                if (BOcli.getBoolean_insertar_cliente_con_recibo_pago(ENTcli, ENTcc1, ENTcc2, ENTgcc2, ENTrpc, ENTscc, ENTcda, ENTtb, tipo_pago, ENTva)) {
                    ...
                    if (ENTrpc.getQuien_llama() == 1) {
                        DAOcli.actualizar_tabla_cliente(conn, FrmCliente.tblcliente_credito_resumen, "","order by saldo_credito asc ");
...
//                    DAOgcc.cargar_grupo_credito_cliente_id(conn, ENTgcc, fk_idcliente);
    ...
    private void reestableser() {
        ...
        txtfecha_recibo.setText(evefec.getString_formato_fecha_barra());
        ...
        txtfecha_transaccion.setText(evefec.getString_formato_fecha_barra());
    ...
    private void initComponents() {
        ...
        panel_nuevo_recibo = new javax.swing.JPanel();
        ...
        txtfecha_transaccion = new javax.swing.JTextField();
        ...
        txtfecha_recibo = new javax.swing.JTextField();
        ...
        panel_nuevo_recibo.setBackground(new java.awt.Color(153, 204, 255));
        panel_nuevo_recibo.setBorder(javax.swing.BorderFactory.createTitledBorder("CREAR DATO"));
        ...
        txtfecha_transaccion.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtfecha_transaccion.setBorder(javax.swing.BorderFactory.createTitledBorder("Fecha Transaccion"));
        txtfecha_transaccion.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtfecha_transaccionKeyReleased(evt);
            }
        });
        ...
        jPanel_datobancoLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_datobancoLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_datobancoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel_datobancoLayout.createSequentialGroup()
                        .addComponent(txtfecha_transaccion, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel_datobancoLayout.setVerticalGroup(
            ...
            .addGroup(jPanel_datobancoLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtfecha_transaccion, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jFva_monto_saldo.setBackground(new java.awt.Color(255, 255, 102));
        ...
        txtfecha_recibo.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtfecha_recibo.setBorder(javax.swing.BorderFactory.createTitledBorder("Fecha Recibo"));

        javax.swing.GroupLayout panel_nuevo_reciboLayout = new javax.swing.GroupLayout(panel_nuevo_recibo);
        panel_nuevo_recibo.setLayout(panel_nuevo_reciboLayout);
        panel_nuevo_reciboLayout.setHorizontalGroup(
            panel_nuevo_reciboLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panel_nuevo_reciboLayout.createSequentialGroup()
                .addGroup(panel_nuevo_reciboLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(panel_nuevo_reciboLayout.createSequentialGroup()
                        .addComponent(txtid, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtfecha_recibo, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panel_nuevo_reciboLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panel_nuevo_reciboLayout.setVerticalGroup(
            panel_nuevo_reciboLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panel_nuevo_reciboLayout.createSequentialGroup()
                .addGap(3, 3, 3)
                .addGroup(panel_nuevo_reciboLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtfecha_recibo, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane1.addTab("CREAR RECIBO", panel_nuevo_recibo);
...
//        boton_guardar(3);
    ...
    private void txtfecha_transaccionKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfecha_transaccionKeyReleased
        // TODO add your handling code here:
        txtfecha_recibo.setText(txtfecha_transaccion.getText());
    }//GEN-LAST:event_txtfecha_transaccionKeyReleased
    ...
    private javax.swing.JPanel panel_nuevo_recibo;
    ...
    private javax.swing.JTextField txtfecha_recibo;
    private javax.swing.JTextField txtfecha_transaccion;
