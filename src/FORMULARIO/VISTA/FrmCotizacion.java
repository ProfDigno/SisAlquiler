...
public class FrmCotizacion extends javax.swing.JInternalFrame {
    ...
    void boton_editar() {
        if (validar_guardar()) {
            coti.setIdcotizacion(1);
            coti.setDolar_guarani(evejtf.getDouble_format_nro_entero(txtdolar_guarani));
            coti.setReal_guarani(evejtf.getDouble_format_nro_entero(txtreal_guarani));
    ...
    private void cargar_datos_cotizacion() {
        ...
        FrmMenuAlquiler.jFdolar.setValue(coti.getDolar_guarani());
        FrmMenuAlquiler.jFreal.setValue(coti.getReal_guarani());
