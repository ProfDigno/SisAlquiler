...
private double C24precio_alquiler;
private double C25precio_reposicion;
private String C26descripcion;
...
//---------------GET-SET-CAMPOS---------------
    ...
    public double getC24precio_alquiler() {
        return C24precio_alquiler;
    }

    public void setC24precio_alquiler(double C24precio_alquiler) {
        this.C24precio_alquiler = C24precio_alquiler;
    }

    public double getC25precio_reposicion() {
        return C25precio_reposicion;
    }

    public void setC25precio_reposicion(double C25precio_reposicion) {
        this.C25precio_reposicion = C25precio_reposicion;
    }

    public String getC26descripcion() {
        return C26descripcion;
    }

    public void setC26descripcion(String C26descripcion) {
        this.C26descripcion = C26descripcion;
    }
