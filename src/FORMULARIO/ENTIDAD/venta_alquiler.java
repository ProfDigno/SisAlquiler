...
private double C29monto_descuento;
...
//---------------GET-SET-CAMPOS---------------
    ...
    public double getC29monto_descuento() {
        return C29monto_descuento;
    }

    public void setC29monto_descuento(double C29monto_descuento) {
        this.C29monto_descuento = C29monto_descuento;
    }

    public double getC30monto_sena() {
        return C30monto_sena;
    }

    public void setC30monto_sena(double C30monto_sena) {
        this.C30monto_sena = C30monto_sena;
    }

    public String getC31monto_letra() {
        return C31monto_letra;
    }

    public void setC31monto_letra(String C31monto_letra) {
        this.C31monto_letra = C31monto_letra;
    }

    public int getC32fk_idtipo_evento() {
        return C32fk_idtipo_evento;
    }
