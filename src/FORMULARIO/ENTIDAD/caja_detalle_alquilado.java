...
public class caja_detalle_alquilado {
     ...
     */
    public double getC24monto_alquilado_credito() {
        return C24monto_alquilado_credito;
    }

    /**
     * @param C24monto_alquilado_credio the C24monto_alquilado_credio to set
     */
    public void setC24monto_alquilado_credito(double C24monto_alquilado_credio) {
        this.C24monto_alquilado_credito = C24monto_alquilado_credio;
    }
...
//---------------DECLARAR VARIABLES---------------
    ...
    private double C24monto_alquilado_credito;
    private String C25forma_pago;
    private double C26monto_recibo_efectivo;
    private double C27monto_recibo_tarjeta;
    private double C28monto_recibo_transferencia;
...
//---------------GET-SET-CAMPOS---------------
    ...
    public double getC26monto_recibo_efectivo() {
        return C26monto_recibo_efectivo;
    }

    public void setC26monto_recibo_efectivo(double C26monto_recibo_efectivo) {
        this.C26monto_recibo_efectivo = C26monto_recibo_efectivo;
    }

    public double getC27monto_recibo_tarjeta() {
        return C27monto_recibo_tarjeta;
    }

    public void setC27monto_recibo_tarjeta(double C27monto_recibo_tarjeta) {
        this.C27monto_recibo_tarjeta = C27monto_recibo_tarjeta;
    }

    public double getC28monto_recibo_transferencia() {
        return C28monto_recibo_transferencia;
    }

    public void setC28monto_recibo_transferencia(double C28monto_recibo_transferencia) {
        this.C28monto_recibo_transferencia = C28monto_recibo_transferencia;
    }
