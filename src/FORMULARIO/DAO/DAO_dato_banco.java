...
public class DAO_dato_banco {
    ...
    private String sql_insert = "INSERT INTO dato_banco(iddato_banco,titular,documento,nro_cuenta,activo,fk_idbanco) VALUES (?,?,?,?,?,?);";
    private String sql_update = "UPDATE dato_banco SET titular=?,documento=?,nro_cuenta=?,activo=?,fk_idbanco=? WHERE iddato_banco=?;";
    private String sql_select = "SELECT db.iddato_banco as id,db.titular,db.nro_cuenta,b.nombre as banco "
            ...
            + "order by 1 desc;";
    private String sql_cargar = "SELECT iddato_banco,titular,documento,nro_cuenta,activo,fk_idbanco FROM dato_banco WHERE iddato_banco=";
    ...
    public void insertar_dato_banco(Connection conn, dato_banco dban) {
        ...
        try {
            ...
            pst.setBoolean(5, dban.getC5activo());
    ...
    public void update_dato_banco(Connection conn, dato_banco dban) {
        ...
        try {
            ...
            pst.setBoolean(4, dban.getC5activo());
    ...
    public void cargar_dato_banco(Connection conn, dato_banco dban, int id) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                dban.setC5activo(rs.getBoolean(5));
