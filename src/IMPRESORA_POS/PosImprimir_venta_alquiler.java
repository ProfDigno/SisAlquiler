...
public class PosImprimir_venta_alquiler {
    ...
    private void cargar_datos_venta_alquiler(Connection conn, int idventa) {
        ...
        String sql = "select v.idventa_alquiler as idva,\n"
                ...
                + "TRIM(to_char(iv.precio_alquiler,'999G999G999')) as precio,"
                + "iv.precio_alquiler as precioint,\n"
                + "TRIM(to_char((iv.cantidad_pagado*iv.precio_alquiler),'999G999G999'))  as sub_pago,\n"
                + "(iv.cantidad_total-iv.cantidad_pagado) as cant_rese,\n"
                + "TRIM(to_char(((iv.cantidad_pagado)*iv.precio_alquiler),'999G999G999'))  as sub_rese\n"
